...
def test_calculate_cost_haiku():
    cost = calculate_cost("anthropic/claude-haiku-4.5", input_tokens=1_000_000, output_tokens=1_000_000)
    assert abs(cost - 4.80) < 0.001

def test_calculate_cost_sonnet():
    cost = calculate_cost("anthropic/claude-sonnet-4.6", input_tokens=1_000_000, output_tokens=1_000_000)
